        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-dark p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="student-list.php"><i class="fas fa-user"></i> <span>Student</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php"><i class="fas fa-user-tie"></i> <span>Admin</span></a></li>
            ...
            ?>
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <button type="button" class="btn btn-danger d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#removeStudent">Remove Student</button>
                        <!-- Modal -->
                        <div class="modal fade" id="removeStudent" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="removeStudentLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="removeStudentLabel">Remove Student</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                    Are you really sure to remove this student?
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <div class="m-0" id="createdDate">Exam 1</div>    
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="mb-3">
                                                <label class="form-label" for="facialId">
                                                    <strong>Attendee Status</strong>
                                                </label>
                                                <div class="m-0 text-success" id="facialId">Attended</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Student Information</p>
                                        </div>
                                        <div class="card-body">
                                            <form>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="mobileNo"><strong>Mobile No.</strong></label><input class="form-control" type="text" id="mobileNo" placeholder="09*********" name="mobile"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <select disabled="true" name="emailverify" id="emailverify" class="form-select">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="m-0" id="createdDate">12 Sept 2021</div>    
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="facialId">
                                                                <strong>Facial Recognation ID</strong>
                                                            </label>
                                                            <div class="m-0" id="facialId">A1311cVST2658</div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="mb-3"><label class="form-label" for="address"><strong>Street</strong></label><input class="form-control" type="text" id="address" placeholder="Sunset Blvd, 38" name="address"></div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="city"><strong>Municipality/City</strong></label><input class="form-control" type="text" id="city" placeholder="Los Angeles" name="city"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="country"><strong>Provice</strong></label><input class="form-control" type="text" id="country" placeholder="USA" name="country"></div>
                                                    </div>
                                                </div>
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit">Save&nbsp;Settings</button></div>
                                            </form>
                    ...
                    <div class="card shadow mb-5">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Student Examinations</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
