<?php
    ...
    if(isset($_SESSION)){
        ...
        if($getError){
            $getErrorLogin = $getError->errorSystem;
        }
        if($getSuccess){
            echo '<script>alert("' .$getSuccess. '")</script>';
        }
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="actions/action.php" method="post">
                                        <div class="mb-3"><input class="form-control form-control-user" type="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." name="loginEmail"></div>
                                        <div class="mb-3"><input class="form-control form-control-user" type="password" id="exampleInputPassword" placeholder="Password" name="loginPassword"></div>
                                        <p><?php echo $getErrorLogin; ?></p>
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox small">
                                                <div class="form-check"><input class="form-check-input custom-control-input" type="checkbox" id="formCheck-1"><label class="form-check-label custom-control-label" for="formCheck-1">Remember Me</label></div>
                                            </div>
                                        </div><button class="btn btn-primary d-block btn-user w-100" type="submit" name="loginAdmin">Login</button>
