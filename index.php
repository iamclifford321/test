                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3 mb-4">
                            <a class="nav-link" href="student-list.php">
                                <div class="card border-start-primary py-2 dash-card">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Manage</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>STUDENTS</span></div>
                                            </div>
                                            <div class="col-auto"><i class="fas fa-id-card fa-2x text-gray-1000"></i></div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <a class="nav-link" href="question.php">
                                <div class="card border-start-success py-2 dash-card">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Manage</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>QUESTION</span></div>
                                            </div>
                                            <div class="col-auto"><i class="fas fa-question-circle fa-2x text-black-300"></i></div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <a class="nav-link" href="examination.php">
                                <div class="card border-start-info py-2 dash-card">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Manage</span></div>
                                                <div class="row g-0 align-items-center">
                                                    <div class="col-auto">
                                                        <div class="text-dark fw-bold h5 mb-0 me-3"><span>EXAMINATION</span></div>
                                                    </div>
                                                    <!-- <div class="col">
                                            ...
                                            <div class="col-auto"><i class="fas fa-tasks fa-2x text-black-300"></i></div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <a class="nav-link" href="admin.php">
                                <div class="card border-start-warning py-2 dash-card">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Manage</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>ADMIN</span></div>
                                            </div>
                                            <div class="col-auto"><i class="fas fa-user-tie fa-2x text-black-300"></i></div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-success fw-bold m-0">Recent Updates</h6>
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-success fw-bold m-0">Recent Activities</h6>
